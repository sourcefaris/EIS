...
public class StringUtils {
	...
	/**
	 * Replace one or more character with backslah \ Example: Faris's become
	 * Faris\'s
	 * 
	 * @return a modified String as a String.
	 */
	public static final String addBackSlashQuote(String str) {
		String str1;
	 ...
	 * @return a modified String as a String.
	 */
	public static final String replaceLineBreak(String string) {
	...
	/**
	 * Add backslashquote replace < and > become & lt dan & gt Example: Faris\n
	 * become Faris<br>
	 * 
	 * @return a modified String as a String.
	 */
	public static final String replaceHTMLInput(String string) {
	...
	public static void main(String[] args) {
		String passEncrypt = new StringUtils().encodeBase64("isat");
		System.out.println("Password Encrypt = "+passEncrypt);
	}
